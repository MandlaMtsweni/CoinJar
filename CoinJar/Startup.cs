using CoinJar.Api;
using CoinJar.DataAccessManagement;
...
namespace CoinJar
{
    public class Startup
    {
        ...
        {   
           ...
           // services.AddTransient<ICoinJar>();
            services.AddTransient<ICoinRepository, CoinRepository>();
            services.AddTransient<ICoinApi, CoinApi>();
            services.AddTransient<IDapperAdapter, DapperAdapter>();
        }
